...
import lord.main.androidlessons.supporting_classes.SpinnerAdapter
...
class ActivityCreateNotification : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) = runBlocking {
        ...
        bindService(
            Intent(this@ActivityCreateNotification, ServiceBdConnection::class.java),
            bdRoomServiceConnection,
            BIND_AUTO_CREATE
        )
        icon = findViewById(R.id.notify_icon)
        icon.adapter = SpinnerAdapter(
            this@ActivityCreateNotification,
